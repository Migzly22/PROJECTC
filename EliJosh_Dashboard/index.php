	...
	<div id="modal" class="modal">
		<form action="./AjaxLogic/SAVING1.php" id="SHET" method="post" enctype="multipart/form-data">
			...
			<div style="display: flex; justify-content: space-between;align-items:center;margin-bottom:0.5em;">
				...
				<input  required type="number" id="swal-input12" name="swal-input2" class="SWALinput swal2Put" required value='' style='padding:0.5em;'>
			</div>
			<div style="display: flex; justify-content: space-between;align-items:center;margin-bottom:0.5em;">
				<label for="inputLabel">Night Price</label>
				<input  required type="number" id="swal-input13" name="swal-input3" class="SWALinput swal2Put" required value='' style='padding:0.5em;'>
			</div>
			<div style="display: flex; justify-content: space-between;align-items:center;margin-bottom:0.5em;">
				<label for="inputLabel">22 Hours Price</label>
				<input  required type="number" id="swal-input14" name="swal-input4" class="SWALinput swal2Put" required value='' style='padding:0.5em;'>
			</div>
			<div style="display: flex; justify-content: space-between;align-items:center;margin-bottom:0.5em;">
				<label for="inputLabel">Max Number</label>
				<input  required type="number" id="swal-input15"  name="swal-input5" class="SWALinput swal2Put" required value='' style='padding:0.5em;'>
			</div>
			<div style="display: flex; justify-content: space-between;align-items:center;margin-bottom:0.5em;">
				<label for="inputLabel">Description</label>
				<textarea  required  id="swal-input16"  name="swal-input6" cols="30" rows="10" style='padding:0.5em;'></textarea>
			</div>
			<div style="display: flex; justify-content: space-between;align-items:center;margin-bottom:0.5em;">
				<label for="inputLabel">Amenities</label>
				<textarea required id="swal-input17"  name="swal-input7" cols="30" rows="10" style='padding:0.5em;'></textarea>
			</div>
			<div style="display: flex; justify-content: space-between;align-items:center;margin-bottom:0.5em;">
