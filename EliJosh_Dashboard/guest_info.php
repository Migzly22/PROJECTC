<?php
    ...
    $sqlcode1 = "SELECT a.*, b.* FROM guests a LEFT JOIN reservations b ON a.GuestID = b.GuestID WHERE a.GuestID = '$userid';";
	...
	<div class="head-title">
		<div class="left">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a class="active" href="./index.php?nzlz=guest">Home</a>
				</li>
				<li><i class='bx bx-chevron-right' ></i></li>
				<li>
					<a class="active" href="#">Guest Information</a>
				</li>
			</ul>
		</div>
