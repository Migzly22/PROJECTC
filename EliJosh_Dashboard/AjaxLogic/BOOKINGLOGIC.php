...
$default = "SELECT a.*, b.*, CONCAT(b.LastName,', ', b.FirstName) as Name, c.* FROM reservations a LEFT JOIN guests b ON a.GuestID = b.GuestID LEFT JOIN notification c ON a.ReservationID = c.reservationID AND c.Status = 'Pending'  ORDER BY a.CheckInDate DESC;";
