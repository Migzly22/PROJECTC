...
<script>
    ...
    async function CurrentMonthtarget(DATASQLCODE = "") {
        ...
        const config = {
            ...
            data: data,
            options: {
                // Add options as needed for your bar chart
            },
            plugins: []
        };
...
*/
            ...
            $.ajax({
				...
				type:"POST",
				data:`imgs=${encodeURIComponent(chartImage)}`,
				beforeSend:function(){
				...
				success:function(data){
					...
					SweetSuccess();
                    location.href = `../Admins/Composer/overallreport.php?sqlcode=${ALLSQLCODE}&imgs=${encodeURIComponent(chartImage)}`///Composer/paymentreport.php?sqlcode=${ALLSQLCODE}
					//console.log(data)
				}
			}); 
