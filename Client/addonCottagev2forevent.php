...
?>
  ...
  <script>
        ...
        REGFORM.addEventListener('submit', async (e) => {
          ...
          location.href = `${reflink}?cin=<?php echo $_GET["cin"];?>&ETIME=<?php echo $_GET["ETIME"];?>&package=<?php echo $_GET["package"];?>&tRANGE=<?php echo $_GET["tRANGE"];?>&na=<?php echo $_GET["na"];?>&nk=<?php echo $_GET["nk"];?>&ns=<?php echo $_GET["ns"];?>&tinit=${TOTALINIT}&eventlist=<?php echo $_GET["eventlist"];?>&roomlist=<?php echo $_GET["roomlist"];?>&cotlist=${stringedJSON}`;
