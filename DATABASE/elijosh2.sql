...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 09, 2023 at 03:15 PM
...
CREATE TABLE IF NOT EXISTS `extracharges` (
  ...
  PRIMARY KEY (`ExtraID`)
) ENGINE=MyISAM AUTO_INCREMENT=10038 DEFAULT CHARSET=utf8mb4;
...
(1, '1234567890', 'johndoe@example.com', 'Johnqwe', 'Doe', 'Michael', 'Male', '1985-04-15', '123 Main Street', 'Los Angeles', '90001', 'United States', '555-555-5555', 'ADMIN'),
(24, 'Nazarene@09', 'n.dbalor@gmail.com', 'nazarene', 'balor', 'de vera', NULL, NULL, 'wellington place', 'GENERAL TRIAS, CAVITE', NULL, 'PH', '09978633698', 'CLIENT'),
(22, 'qwertyuiop', 'ferriseris12@gmail.com', 'Rolly', 'Migrino', 'Migrino', NULL, NULL, 'Blk 16 lot 9 Acacia homes', 'CITY OF DASMARIÑAS, CAVITE', NULL, 'PH', '09991570900', 'CLIENT'),
(21, 'RolliardMigrino09991570900', 'noncre123@gmail.com', 'Rolliard', 'Migrino', 'Lamparas', 'Male', '2001-06-29', 'Blk 16 lot 9 Acacia homes', 'Dasmariñas City, Cavite', '4114', 'Philippines', '09991570900', 'CLIENT'),
(26, 'Testing@123', 'elijosh111923@gmail.com', 'MICHELLE', 'qweqweqwe', 'MIGZ', NULL, NULL, 'Blk 16 lot 9 Acacia homes', 'CALANASAN (BAYAG), APAYAO', NULL, 'PH', '09991570900', 'CLIENT'),
(27, 'Testing@123', 'ferriseris12@gmail.com', 'Rolly', 'Lam', 'SANEN', NULL, NULL, 'Blk 16 lot 9 Acacia homes', 'ALFONSO, CAVITE', NULL, 'PH', '09991570900', 'CLIENT');
COMMIT;
