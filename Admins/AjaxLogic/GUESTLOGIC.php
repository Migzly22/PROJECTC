...
$sqlcode3 = "SELECT a.*, b.*, CONCAT(a.LastName,', ', a.FirstName) as Name FROM guests a LEFT JOIN reservations b ON a.GuestID = b.GuestID ORDER BY a.Lastname, a.Firstname;";
    ...
    while ($result = mysqli_fetch_assoc($querynum3)) {
        ...
        <tr>
            ...
            <td class='ActionTABLE' id ='".$result['GuestID']."'>
                ...
                <button class='addbtn' onclick='PAYMENT(this)'>
